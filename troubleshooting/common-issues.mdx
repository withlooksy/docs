...
### Issue: "Try it on" button doesn't show on product pages
...
<AccordionGroup>
  <Accordion title="Result Doesn't Look Realistic">
    **Possible causes:**
    ...
    - Low-quality selfie (dark, angled, blurry)
    - Product type not ideal for try-on

    **Solution:**
    1. Check product image meets requirements (plain background, good lighting)
    2. Retake selfie in better lighting, facing camera directly
  ...
  <Accordion title="Garment Placement is Off">
    **Possible causes:**
    ...
    - Angled selfie (not facing camera)
    - Product image not front-facing
    - Garment type has limitations (very drapey, oversized)

    **Solution:**
    1. Retake selfie facing camera directly
    2. Check product image is front-facing and centered
    3. Test with different products to isolate issue
  </Accordion>

...
- **High resolution** – Clear, detailed photos
- **Good lighting** – Avoid shadows and dark images
- **Plain backgrounds** – Help the AI isolate the product
- **Multiple angles** – Up to 4 images per product

### What the AI Needs

The model works with any images, but quality improves with:
- Front-facing product views

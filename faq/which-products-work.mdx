...
Looksy is optimized for **apparel and clothing items** worn on the upper body. The technology works best with garments that have clear structure and can be accurately rendered on different body types.
...
**Why they work:** Fitted activewear has clear structure and benefits from try-on visualization.
...
**Status:** Lower body try-on is in development. Currently, Looksy focuses on upper body garments for optimal accuracy.
...
**Why:** Footwear try-on requires foot and leg rendering, which is not part of the current upper-body focus.
...
<AccordionGroup>
  <Accordion title="Can I use virtual try-on for accessories like jewelry?">
    Not currently. Looksy is optimized for apparel worn on the upper body. Accessories require different rendering technology.
  </Accordion>

  <Accordion title="Do pants and bottoms work with virtual try-on?">
    Lower body try-on is in development. Currently, Looksy focuses on upper body garments (tops, dresses, jackets) for the best accuracy.
  </Accordion>

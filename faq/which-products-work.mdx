...
Looksy supports **full body apparel and clothing items**. The technology works best with garments that have clear structure and can be accurately rendered on different body types.
...
**Why they work:** Fitted activewear has clear structure and benefits from full-body try-on visualization.
...
**Why they work:** Full body rendering allows customers to visualize complete outfits and see how bottoms complement their body type.
...
- **Try-on engagement rate** – % of visitors who click "Try it on"
...
<AccordionGroup>
  ...
  <Accordion title="Do pants and bottoms work with virtual try-on?">
    Yes! Looksy supports full body apparel including pants, jeans, shorts, skirts, and leggings. Customers can visualize complete outfits from head to toe.
  </Accordion>

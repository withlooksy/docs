...
Pricing can change. Confirm commercial answers against both the [Looksy website](https://withlooksy.com/) and [Shopify App Store listing](https://apps.shopify.com/looksy) before relying on them.
...
4. For volatile commercial facts, re-check the public website and Shopify listing.
...
- [Gorgias setup](https://withlooksy.com/docs/integration/gorgias)

...
<CardGroup cols={2}>
  <Card title="Button Placement" icon="location-dot">
    Test where the "Try it on" button appears on product pages
  </Card>
...
**Question:** Where should the "Try it on" button be placed for maximum engagement?
...
**Hypothesis:** Action-oriented, benefit-focused copy ("See it on you") will outperform generic copy ("Try it on").

### Test Setup

**Variant A (Control):** "Try it on"
...
**Variants:**
- A: Above fold + "Try it on"
- B: Above fold + "See it on you"
- C: Below fold + "Try it on"

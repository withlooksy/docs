...
<CardGroup cols={2}>
  ...
  <Card title="Button Styling" icon="palette">
    Test colors, sizes, and visual styling
  </Card>
  ...
  <Card title="Product Selection" icon="check-circle">
    Test which product categories benefit most
  </Card>
</CardGroup>
...
- Mobile vs. desktop button styling
...
<Tip>
Start with button copy and styling tests – they typically deliver the biggest wins with minimal effort.
</Tip>
